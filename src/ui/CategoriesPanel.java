...
private JPanel createCategoryGrid(ArrayList<Category> categoryList, String type) {
    JPanel gridPanel = new JPanel(new GridLayout(0, 4, 15, 15)); // 4 columns, auto rows
    ...
    private JPanel createModernCategoryCard(Category cat, String type, int index) {
        ...
        // === Overlay container (layered) ===
        JLayeredPane layeredPane = new JLayeredPane();
        layeredPane.setPreferredSize(new Dimension(140, 140));
        layeredPane.setMinimumSize(new Dimension(140, 140));
        layeredPane.setMaximumSize(new Dimension(140, 140));
        layeredPane.setLayout(null); // manual positioning
        
        // center the card inside the layered pane
        card.setBounds(0, 0, 140, 140);
        ...
        if (editMode) {
            ...
            cb.setBounds(110, 5, 25, 25); // top-right overlay
        ...
        // === Wrapper ensures proper sizing in grid ===
        JPanel wrapper = new JPanel(new BorderLayout());
        wrapper.setOpaque(false);
        wrapper.setPreferredSize(new Dimension(140, 140));
...
private JPanel createAddCategoryCard(String type) {
    ...
    // === Overlay container (layered) - MATCH THE CATEGORY CARD STRUCTURE ===
    JLayeredPane layeredPane = new JLayeredPane();
    layeredPane.setPreferredSize(new Dimension(140, 140));
    layeredPane.setMinimumSize(new Dimension(140, 140));
    layeredPane.setMaximumSize(new Dimension(140, 140));
...
private void showAddCategoryModal(String type) {
    ...
    iconArea.setAlignmentX(Component.CENTER_ALIGNMENT);
    ...
    addBtn.addActionListener(e -> {
        ...
        if (type.equals("expenses")) expenseCategories.add(newCat);
        else incomeCategories.add(newCat);
    ...
    // ===== Center wrapper like in addTransaction =====
